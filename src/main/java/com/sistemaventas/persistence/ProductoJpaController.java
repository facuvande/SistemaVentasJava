...
public class ProductoJpaController implements Serializable {
    ...
    public void edit(Producto producto) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Venta ventaOld = persistentProducto.getVenta();
            Venta ventaNew = producto.getVenta();
            if (ventaNew != null) {
                ventaNew = em.getReference(ventaNew.getClass(), ventaNew.getId());
                producto.setVenta(ventaNew);
            }
            producto = em.merge(producto);
            if (ventaOld != null && !ventaOld.equals(ventaNew)) {
                ventaOld.getProductos().remove(producto);
                ventaOld = em.merge(ventaOld);
            }
            if (ventaNew != null && !ventaNew.equals(ventaOld)) {
                ventaNew.getProductos().add(producto);
