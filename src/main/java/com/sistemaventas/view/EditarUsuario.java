...
public class EditarUsuario extends javax.swing.JFrame {
    ...
    public EditarUsuario(Controller control, Usuario myUser) {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtSurname.setText(myUser.getSurname());
        txtDni.setText(myUser.getDni());
        txtPassword.setText(myUser.getPassword());
        txtUser.setText(myUser.getUsername());
        cmbRole.setSelectedItem(myUser.getRol().getName());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        control.editUser(myUser, name, surname, dni, password, user, role);
        mostrarMensaje("Usuario editado con exito", "Info", "Edicion exitosa");
        this.dispose();
